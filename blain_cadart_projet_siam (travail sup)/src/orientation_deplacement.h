 ...
 * *****************
 * Verifie qu'une orientation correspond a une enumeration possible.
 * C'est a dire, l'orientation peut être haut (0), bas (1), gauche (2), droite (3) et aucune orientation (4).
 *
 * Necessite :
 *  - une enumeration de type orientation_deplacement
 * Garantie :
 *  - Si l'orientation est correcte (comprise entre 0 et 5), elle retourne 1.
 ...
 * **********************
 * Verifie qu'on rentre un caractere valide (<, >, ^, v).
 * Necessite :
 *  - un caractere designant la touche sur laquelle l'utilisateur a appuye.
 * Garantie :
 *  - Un retour valant 1 si le caractere saisi est valide.
 *  - Un retour valant 0 sinon.
 */
