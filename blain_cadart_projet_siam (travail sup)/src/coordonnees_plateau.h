 ...
 * *********************
 * Applique un deplacement a la piece selon son orientation.
 *
 * Necessite
 *  - deux pointeurs sur une coordonnee d'une piece non NULL et modifiable.
 *  - une orientation qui doit etre integre.
 * Garantis :
 *      - La modification de la coordonnee de la piece dans l'orientation donnee.
 *      - Un affichage d'erreur si l'orientation n'est pas integre.
 */
